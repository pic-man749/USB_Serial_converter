...
#ifndef APP_APPCONFIG_HPP_
#define APP_APPCONFIG_HPP_
...
namespace App {
   ...
   */
  enum class UartChannel : uint8_t { UART1 = 0, UART2, UART3 };

  /** OLED の表示形式 */
  enum class DisplayMode : uint8_t { Hex, Ascii };
